...
#define TX_FRONT(n)		GPIO_WriteBit(GPIOB, GPIO_Pin_9, (BitAction)(n))
#define TX_90DEG(n)		GPIO_WriteBit(GPIOC, GPIO_Pin_13, (BitAction)(n))
#define TX_45DEG(n)		GPIO_WriteBit(GPIOC, GPIO_Pin_3, (BitAction)(n))
