...
void LCD_Init(void)
{
    ...
    /* Reset LCD */
    HAL_GPIO_WritePin(FSMC_LCD_RESET_GPIO_Port, FSMC_LCD_RESET_Pin, GPIO_PIN_RESET);
    _delay(100000);	
    HAL_GPIO_WritePin(FSMC_LCD_RESET_GPIO_Port, FSMC_LCD_RESET_Pin, GPIO_PIN_SET);

    // Set the PWM Port to 1
    HAL_GPIO_WritePin(FSMC_LCD_PWM_GPIO_Port, FSMC_LCD_PWM_Pin, GPIO_PIN_SET);
